...
import { RARITY_COLOR } from "helpers/boxInfo";
import LinkIcon from 'assets/icons/link.svg';
import { capitalizeFirstLetter } from 'helpers/text';

export const CardNFT = ({ result }) => {
  ...
  return (
    <div className="nftCard-lineGradient flex items-center justify-center p-1 rounded-[40px]">
      <div className="flex flex-col p-2.5 pb-3.5 nftCard-wrapper rounded-[40px]">
        ...
        <div className="flex items-center justify-between text-white-800  mb-3 px-2.5">
          ...
          <div className={`py-[5px] px-2.5 text-white-800 text-[12px] leading-[14px] rounded-[30px] ${RARITY_COLOR[finalRarity]}`}>
            {finalRarity}
          </div>
        </div>
        <div className="flex items-center justify-between px-[20px] py-5 text-[12px] leading-[14px] nftCard__power-wrapper rounded-[30px]">
          ...
          <a href={result?.scan_url} target="_blank" className="cursor-pointer hover:underline flex items-center justify-end space-x-1">
